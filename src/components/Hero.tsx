  ...
  return (
    <div className={"h-dvh w-screen relative overflow-x-hidden"}>
      {isLoading && (
        <div
          className={
            "flex-center w-screen h-dvh z-[100] absolute overflow-hidden bg-violet-50"
          }
        >
        ...
        <div className="">
          <div className="mask-clip-path absolute-center absolute z-50 size-64  cursor-pointer overflow-hidden rounded-lg">
            ...
            >
              <video
                className={
                  "size-64 origin-center object-cover object-center scale-150"
                }
                ref={nextVideoRef}
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-72 font-robert-regular text-blue-100">
              Enter the world of web development with the best digital
              experience
            </p>
            <Button
              id={"watch-trailer"}
              title={"Transform Your Ideas with Us"}
